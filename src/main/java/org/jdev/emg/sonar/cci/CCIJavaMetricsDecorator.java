 ...
 * @see org.adf.emg.sonar.ojaudit.JavaMetricsDecorator 
 */
public class CCIJavaMetricsDecorator implements Decorator {

    private static final Logger LOG = LoggerFactory.getLogger(CCIJavaMetricsDecorator.class);
    ...
    public CCIJavaMetricsDecorator() {
        super();
    }
